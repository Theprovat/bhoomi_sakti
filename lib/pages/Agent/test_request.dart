...
//   final TextEditingController _soilConcernsController = TextEditingController();
...
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: AppBar(title: Text('Create Soil Test Request')),
//       body: Padding(
...
//             ),
//             TextField(
//               controller: _soilConcernsController,
//               decoration:
//                   InputDecoration(labelText: 'Soil Concerns (Optional)'),
//             ),
//             SizedBox(height: 10),
//             Row(
